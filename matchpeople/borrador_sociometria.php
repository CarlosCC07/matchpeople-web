...
<?php include("menus/menu_vacantes.php");?>
  ...
  <div class="centar" style="width: 90% !important;">
    <?php
	 ...
	 INNER JOIN empresas_sociometria ON encuesta_sociometria.IdEmpresa=empresas_sociometria.IdEmpresa where encuesta_sociometria.estatusId = 2 AND encuesta_sociometria.papeleria != 1 ";
